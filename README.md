...
```bash
java -jar target/result-json-map-cli-0.1.0-SNAPSHOT.jar field=value field2=value2
```
...
```bash
java -jar target/result-json-map-cli-0.1.0-SNAPSHOT.jar build "field" 30 "field2" "John"
```
...
```bash
java -jar target/result-json-map-cli-0.1.0-SNAPSHOT.jar name:John age:30 city:New York
```
...
```bash
java -jar target/result-json-map-cli-0.1.0-SNAPSHOT.jar name="John Doe" email=john@example.com
```
...
```bash
java -jar target/result-json-map-cli-0.1.0-SNAPSHOT.jar age=30 price=19.99 code="123"
```
...
```bash
# Show help
java -jar target/result-json-map-cli-0.1.0-SNAPSHOT.jar --help

# Show version
java -jar target/result-json-map-cli-0.1.0-SNAPSHOT.jar --version
```
...
```bash
java -jar target/result-json-map-cli-0.1.0-SNAPSHOT.jar name=Alice age=25
```
Output:
```xml
...
```bash
java -jar target/result-json-map-cli-0.1.0-SNAPSHOT.jar email=user@example.com path=/home/user/file.txt
```
Output:
```xml
...
```bash
java -jar target/result-json-map-cli-0.1.0-SNAPSHOT.jar name:Bob city:San Francisco
```
Output:
```xml
...
```bash
java -jar target/result-json-map-cli-0.1.0-SNAPSHOT.jar name=Alice age=25 price=19.99 balance=-100.50
```
Output:
```xml
...
```bash
java -jar target/result-json-map-cli-0.1.0-SNAPSHOT.jar build "name" "Alice" "age" 25 "price" 19.99
```
Output:
```xml
